        ...
        <div className="add-new-user-dialog">
          <div className="mb-5">
            ...
            >
              ...
              {avatar ? <img src={avatar} alt='user avatar' className="absolute top-0 left-0 w-full h-full object-fit-cover" /> : null}
            </label>
          </div>
          <div className="field">
            <label
          ...
          <div className="field">
            ...
            <Controller
              name="password"
              control={control}
              rules={{maxLength:{value: 20, message: 'Password is too long'} }}
              render={({ field, fieldState }) => (
                <Password
                  id={field.password}
                  {...field}
